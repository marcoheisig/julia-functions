...
(defun expand-call-method (method next-methods lambda-list method-class)
  (wrap-in-next-methods
   (call-julia-method-lambda
    (coerce-to-julia-method method lambda-list method-class)
    lambda-list)
   next-methods
   lambda-list
   method-class))

(defun coerce-to-julia-method (method lambda-list method-class)
  (cond ((typep method 'julia-method)
         method)
        ((and (consp method)
...
(defun call-julia-method-lambda (method lambda-list)
